...
class MyGame(arcade.Window):
    ...
    def player_at_second_map_exit(self):
        return 330 < self.player_sprite.center_x < 470 and self.player_sprite.center_y <= 40

    def player_at_third_map_entry(self):
        return 330 < self.player_sprite.center_x < 470 and self.player_sprite.center_y >= SCREEN_HEIGHT - 40
