...
class Story(arcade.View):
    ...
    def on_draw(self):
        self.clear()
        arcade.draw_text("Nos encontramos en la época medieval, una época con Muchos habitantes y", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 + 200,
                         arcade.color.WHITE, 11, anchor_x="center")
        arcade.draw_text("poco suministro de alimento para la gran cantidad de población que vivían en los pueblos de estos reinos antiguos.",
                         SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 + 180, arcade.color.WHITE, 11, anchor_x="center")


        arcade.draw_text("Press Enter to Continue", SCREEN_WIDTH / 2, SCREEN_HEIGHT / 2 - 250,
